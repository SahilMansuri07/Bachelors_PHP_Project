            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    <div class="header__top__left">
                        <p>Free shipping, On All Order Up to ₹5000</p>
                    </div>
                </div>
                    ...
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="cart.php"><span>Cart |</span>
                                    <img class="icon" src="../../public/img/icon/cart.png" width="10px" style="color: white;" alt="">
                                </a></li>
                            <?php
                            if (isset($_SESSION['uid'])) {
                                ?>
                                <li><a href="#"> My account | <img class="icon" src="../../public/img/icon/user.png" width="10px"
                                            alt=""></a>
                                    <ul class="dropdown">
                            ...
                            <?php
                                ...
                                ?>
                                <li><a href="/ng2/src/controller/login.php">Login</a></li>
                                <?php
                            }
                            ?>
                        </ul>
