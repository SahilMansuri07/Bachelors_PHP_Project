...
$selectq = mysqli_query($connection, "select * from tbl_product where prod_id='{$editid}'" ) or die(mysqli_error($connection));
...
if($_POST)
{
	...
	$photo=mysqli_real_escape_string($connection , $_POST ['pphoto']);
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
							...
							<div class="form-body">
								<form class="form-horizontal" method="post" enctype="multipart/form-data">
									<input type="hidden" name="id" value="<?php echo $selectrow['prod_id'] ?>">
									 ...
									 <div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['prod_name'] ?>" name="pname" placeholder="Enter Product Name" required> 
									</div>
									</div>
									
									 <div class="form-group">
									 <label for="inputEmail3" class="col-sm-2 control-label">Product Price </label> 
									 <div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['prod_price'] ?>" name="pprice" placeholder="Enter Product Price" required> 
									</div>
									 </div>
									 ...
									 <div class="col-sm-9">
									 <textarea class="form-control" name="pdetail" required><?php echo $selectrow['prod_detail'] ?></textarea>
									</div>
									 </div>
									 <div class="form-group">
									 <label for="inputEmail3" class="col-sm-2 control-label">photo path </label> 
									 <div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['prod_photo'] ?>" name="pphoto" placeholder="Enter photo path" required> 
									</div>
									 </div>
									 <div class="form-group">
									 <label for="inputEmail3" class="col-sm-2 control-label">Product stock </label> 
									 <div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['prod_stock'] ?>" name="pstock" placeholder="Enter stock" required> 
									</div>
									 </div>
									 <div class="form-group">
                             <label for="exampleInputPassword1" value="<?php echo $selectrow['category_id'] ?>" name="cid" required> category :</label>
						...
						<div class="form-group">
                             <label for="exampleInputPassword1"value="<?php echo $selectrow['company_id'] ?>" name="company1"required> Company :</label>
